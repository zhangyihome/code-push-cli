...
export function showHelp(showRootDescription?: boolean): void {
    if (!wasHelpShown) {
        if (showRootDescription) {
            console.log(
                chalk.cyan(
                    "  _____        __  " + chalk.green("  ___           __ ")
                )
            );
            console.log(
                chalk.cyan(
                    " / ___/__  ___/ /__" + chalk.green(" / _ \\__ _____ / / ")
                )
            );
            console.log(
                chalk.cyan(
...
function removeCollaborator(commandName: string, yargs: yargs.Argv): void {
    ...
    yargs
        .usage(
            USAGE_PREFIX + " collaborator " + commandName + " <appName> <email>"
        )
...
function sessionList(commandName: string, yargs: yargs.Argv): void {
    ...
    yargs
        ...
        .example(
            "session " + commandName,
            "Lists your sessions in tabular format"
        )
        .example(
            "session " + commandName + " --format json",
            "Lists your login sessions in JSON format"
        )
        .option("format", {
            default: "table",
            demand: false,
            description:
                'Output format to display your login sessions with ("json" or "table")',
            type: "string",
        });
...
function sessionRemove(commandName: string, yargs: yargs.Argv): void {
    ...
    yargs
        ...
        .demand(/*count*/ 1, /*max*/ 1) // Require exactly one non-option arguments
        .example(
            "session " + commandName + ' "John\'s PC"',
            'Removes the existing login session from "John\'s PC"'
        );
...
function deploymentList(commandName: string, yargs: yargs.Argv): void {
    ...
    yargs
        .usage(
            USAGE_PREFIX + " deployment " + commandName + " <appName> [options]"
        )
        .demand(/*count*/ 1, /*max*/ 1) // Require exactly one non-option arguments
        .example(
...
var argv = yargs
        ...
        (yargs: yargs.Argv) => {
            ...
            */
                ...
                .command(
                    "rm",
                    "Remove an existing access key",
                    (yargs: yargs.Argv) => accessKeyRemove("rm", yargs)
                )
                .command(
                    "list",
    ...
    .command(
        "app",
        "View and manage your CodePush apps",
        (yargs: yargs.Argv) => {
            isValidCommandCategory = true;
            yargs
                ...
                .command(
                    "rm",
                    "Remove an app from your account",
                    (yargs: yargs.Argv) => appRemove("rm", yargs)
                )
                .command(
                    "rename",
                    ...
                    (yargs: yargs.Argv) => {
                        ...
                        yargs
                            .usage(
                                USAGE_PREFIX +
                                    " app rename <currentAppName> <newAppName>"
                            )
                            .demand(/*count*/ 2, /*max*/ 2) // Require exactly two non-option arguments
                            .example(
        ...
        (yargs: yargs.Argv) => {
            ...
            yargs
                ...
                .command(
                    "rm",
                    "Remove a deployment from an app",
                    (yargs: yargs.Argv) => deploymentRemove("rm", yargs)
                )
                .command(
                    "rename",
    ...
    .command(
        ...
        (yargs: yargs.Argv) => {
            yargs
                .usage(
                    USAGE_PREFIX + " patch <appName> <deploymentName> [options]"
                )
                .demand(/*count*/ 2, /*max*/ 2) // Require exactly two non-option arguments
                .example(
    ...
    .command(
        ...
        (yargs: yargs.Argv) => {
            yargs
                .usage(
                    USAGE_PREFIX +
                        " release-cordova <appName> <platform> [options]"
                )
                .demand(/*count*/ 2, /*max*/ 2) // Require exactly two non-option arguments
                .example(
    ...
    .command(
        ...
        (yargs: yargs.Argv) => {
            yargs
                .usage(
                    USAGE_PREFIX +
                        " release-react <appName> <platform> [options]"
                )
                .demand(/*count*/ 2, /*max*/ 2) // Require exactly two non-option arguments
                .example(
                ...
                .option("config", {
                    ...
                    demand: false,
                    description:
                        "Path to the React Native CLI configuration file",
                    type: "string",
                })
                .check(
                    (
    ...
    .command(
        ...
        (yargs: yargs.Argv) => {
            yargs
                .usage(
                    USAGE_PREFIX +
                        " rollback <appName> <deploymentName> [options]"
                )
                .demand(/*count*/ 2, /*max*/ 2) // Require exactly two non-option arguments
                .example(
        ...
        switch (arg0) {
                ...
                switch (arg1) {
                    case "add":
                        if (arg2) {
                            ...
                            */
                            ...
                            accessKeyAddCmd.ttl = parseDurationMilliseconds(
                                "60d"
                            );
                        }
                        break;
                    ...
                    case "patch":
                        if (arg2) {
                            ...
                            var accessKeyPatchCmd = <
                                cli.IAccessKeyPatchCommand
                            >cmd;
                            ...
                            if (isDefined(ttlOption)) {
                                accessKeyPatchCmd.ttl = parseDurationMilliseconds(
                                    ttlOption
                                );
                            }
                        }
                    ...
                    case "ls":
                        ...
                        (<cli.IAccessKeyListCommand>cmd).format =
                            argv["format"];
                        break;
                ...
                switch (arg1) {
                    ...
                    case "transfer":
                        if (arg2 && arg3) {
                            ...
                            var appTransferCommand = <cli.IAppTransferCommand>(
                                cmd
                            );
                ...
                switch (arg1) {
                    ...
                    case "ls":
                        if (arg2) {
                            ...
                            (<cli.ICollaboratorListCommand>cmd).format =
                                argv["format"];
                        }
                        break;
                    ...
                    case "rm":
                        if (arg2 && arg3) {
                            ...
                            (<cli.ICollaboratorRemoveCommand>(
                                cmd
                            )).appName = arg2;
                            (<cli.ICollaboratorAddCommand>cmd).email = arg3;
                        }
                ...
                switch (arg1) {
                    case "add":
                        if (arg2 && (arg3 || argv["default"])) {
                            ...
                            var deploymentAddCommand = <
                                cli.IDeploymentAddCommand
                            >cmd;
                    ...
                    case "rm":
                        if (arg2 && arg3) {
                            ...
                            var deploymentRemoveCommand = <
                                cli.IDeploymentRemoveCommand
                            >cmd;
                    ...
                    case "rename":
                        if (arg2 && arg3 && arg4) {
                            ...
                            var deploymentRenameCommand = <
                                cli.IDeploymentRenameCommand
                            >cmd;
                    ...
                    case "h":
                        if (arg2 && arg3) {
                            ...
                            var deploymentHistoryCommand = <
                                cli.IDeploymentHistoryCommand
                            >cmd;
                            ...
                            deploymentHistoryCommand.displayAuthor =
                                argv["displayAuthor"];
                        }
                        break;
                }
            ...
            case "promote":
                if (arg1 && arg2 && arg3) {
                    ...
                    deploymentPromoteCommand.appStoreVersion =
                        argv["targetBinaryVersion"];
                }
                break;
            ...
            case "release":
                if (arg1 && arg2 && arg3) {
                    ...
                    releaseCommand.noDuplicateReleaseError =
                        argv["noDuplicateReleaseError"];
            ...
            case "release-cordova":
                if (arg1 && arg2) {
                    ...
                    releaseCordovaCommand.deploymentName =
                        argv["deploymentName"];
                    ...
                    releaseCordovaCommand.noDuplicateReleaseError =
                        argv["noDuplicateReleaseError"];
                    releaseCordovaCommand.rollout = getRolloutValue(
                        argv["rollout"]
                    );
                    releaseCordovaCommand.appStoreVersion =
                        argv["targetBinaryVersion"];
                    releaseCordovaCommand.isReleaseBuildType =
                        argv["isReleaseBuildType"];
                    releaseCordovaCommand.privateKeyPath =
                        argv["privateKeyPath"];
                }
                break;
            ...
            case "release-react":
                if (arg1 && arg2) {
                    ...
                    releaseReactCommand.appStoreVersion =
                        argv["targetBinaryVersion"];
                    ...
                    releaseReactCommand.noDuplicateReleaseError =
                        argv["noDuplicateReleaseError"];
                    releaseReactCommand.plistFile = argv["plistFile"];
                    releaseReactCommand.plistFilePrefix =
                        argv["plistFilePrefix"];
